...
JAVA_OPTS_C="-Xms2g -Xmx2g -Xmn1536m -XX:ParallelGCThreads=6"
JAVA_OPTS_TI="-Xms2g -Xmx2g -Xmn1536m -XX:ParallelGCThreads=6"
JAVA_OPTS_BE="-server -Xms25g -Xmx25g -Xmn22g -XX:+AggressiveOpts -XX:-UseBiasedLocking -XX:+UseLargePages -XX:-UseAdaptiveSizePolicy -XX:SurvivorRatio=28 -XX:TargetSurvivorRatio=95 -XX:MaxTenuringThreshold=15 -XX:LargePageSizeInBytes=2m -XX:+UseParallelOldGC -XX:+AlwaysPreTouch -XX:+UseNUMA"
#-XX:+UseTransparentHugePages -XX:LargePageSizeInBytes=2m -XX:ParallelGCThreads=48
