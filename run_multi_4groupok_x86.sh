...
JAVA_OPTS_BE="-server -Xms25g -Xmx25g -Xmn22g -XX:+AggressiveOpts -XX:-UseBiasedLocking -XX:+UseLargePages -XX:-UseAdaptiveSizePolicy -XX:SurvivorRatio=28 -XX:TargetSurvivorRatio=95 -XX:MaxTenuringThreshold=15 -XX:LargePageSizeInBytes=2m -XX:+UseParallelOldGC -XX:ParallelGCThreads=12 -XX:+AlwaysPreTouch"
