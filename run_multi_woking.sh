...
JAVA_OPTS_BE="-server -Xms25g -Xmx25g -Xmn22g -XX:+AggressiveOpts -XX:-UseBiasedLocking -XX:+UseLargePages -XX:-UseAdaptiveSizePolicy -XX:SurvivorRatio=28 -XX:TargetSurvivorRatio=95 -XX:MaxTenuringThreshold=5 -XX:LargePageSizeInBytes=2m -XX:+UseParallelOldGC -XX:ParallelGCThreads=16 -XX:+AlwaysPreTouch" 
#-XX:+UseTransparentHugePages -XX:+UseNUMA 
